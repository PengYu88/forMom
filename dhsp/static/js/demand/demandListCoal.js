tsc.demandListCoal = {
	...
	init: function() {
		...
		// 初始化事件绑定
		tsc.demandListCoal.event();
		
		//初始化分页
		tsc.demandListCoal.doPage();
	},
	...
	event: function() {
		...
		// 查询按钮点击事件
		$("#queryBtn").on("click", tsc.demandListCoal.doQuery);
		// 查询按钮点击事件
	...
	doPage: function(page, total){
		...
		$('#pager-1').bootpag({
        	...
        	// 查询
        	tsc.demandListCoal.doQuery(num);
        });
	},
