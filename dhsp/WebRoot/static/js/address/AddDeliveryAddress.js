tsc.AddDeliveryAddress = {

    // 初始化
    init: function() {

        //表单验证
        tsc.AddDeliveryAddress.validate();

        //事件绑定
        tsc.AddDeliveryAddress.event();
    },

    //事件绑定
    event: function () {
        // 省市区练级联动
        $("#nation").on("change", tsc.AddDeliveryAddress.changeProvince);
        $("#province").on("change", tsc.AddDeliveryAddress.changeCity);
        $("#city").on("change", tsc.AddDeliveryAddress.changeArea);
    },
